...
//
// Standard error codes.  EDOM, EILSEQ and ERANGE are defined by C99.  All
// other values are defined by POSIX/SUS
//
...
#define ENODATA			43	// No message is available on the STREAM
